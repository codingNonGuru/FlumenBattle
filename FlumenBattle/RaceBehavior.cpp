...
void Dwarf::ApplyModifiers(world::settlement::Settlement &settlement) const
{
    ...
    settlement.AddModifier({world::settlement::Modifiers::COMBAT_BONUS_ON_MOUNTAIN_TILES, 2});
...
void Elf::ApplyModifiers(world::settlement::Settlement &settlement) const
{
    ...
    settlement.AddModifier({world::settlement::Modifiers::COMBAT_BONUS_ON_WOOD_TILES, 2});
}
...
void Goblin::ApplyModifiers(world::settlement::Settlement &settlement) const
{
    ...
    settlement.AddModifier({world::settlement::Modifiers::DISTANCE_TO_CAPITAL_INDEPENDENCE_LIMIT, -2});
}