...
public:
	...
	static Word const STENCIL_2;
	static Word const FINAL_STENCIL;
	static Word const TERRAIN_BASE_STENCIL;
};
...
enum class SpellTypes {
	FROST_RAY, SHOCKING_GRASP, SACRED_FLAME, FIRE_BOLT, FIRE_BALL, BURNING_HANDS,
