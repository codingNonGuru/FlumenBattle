...
namespace world::character
{
    ...
    enum class Conditions {SICKENED, FRIGHTENED, PARALYZED, HOBBLED, EVASION, FATIGUE, NOURISHED, BLESSED, WALL_PROTECTION};

    enum class Modifiers {BASE_ATTACK_DIE_TYPE, BASE_ATTACK_DIE_COUNT, BONUS_ARMOR_CLASS, ARMOR_DEXTERITY_LIMIT, ALL_ROLLS_PENALTY, ATTACK_RATING_BONUS, DAMAGE_BONUS, FORTITUDE_BONUS, REFLEX_BONUS, MOVE_SPEED};
